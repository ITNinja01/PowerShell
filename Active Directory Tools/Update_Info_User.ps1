...
$info_org = Get-ADUser $Username -Properties Info | Select-Object -ExpandProperty Info
...
Set-ADUser $Username -Replace @{Info = $info_new } -Verbose  -PassThru | Select-Object DistinguishedName, SID