...
Get-ADUser $UserName -Properties * | Select-Object directreports -ExpandProperty directreports | Get-ADUser -Properties * | Select-Object name, office, officephone, title  